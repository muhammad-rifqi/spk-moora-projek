<nav x-data="{ open: false }" class="fixed top-0 left-0 right-0 bg-white border-b border-gray-100">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-10 space-x-8">
                ...
                <!-- <div x-data="{ open:false }" class="relative">
                    ...
                    <div x-show="open"
                        ...
                        <a href="/periods" class="block px-4 py-2 hover:bg-gray-100">
                            Periode
                        </a>

                        <a href="/scores" class="block px-4 py-2 hover:bg-gray-100">
                            Penilaian
                        </a>
                ...
                <!-- <div x-data="{ open:false }" class="relative">
                    ...
                    <div x-show="open"
                        @click.away="open=false"
                        x-transition
                        class="absolute left-0 mt-2 w-64 bg-white rounded-md shadow-lg border z-50">

                        <a href="/moora/process" class="block px-4 py-2 hover:bg-gray-100">
                            Proses MOORA
                        </a>

                        <a href="/rankings" class="block px-4 py-2 hover:bg-gray-100">
                            Ranking
                        </a>
                ...
                <!-- <div x-data="{ open:false }" class="relative">
                    ...
                    <div x-show="open"
                        ...
                        <a href="/reports/candidates" class="block px-4 py-2 hover:bg-gray-100">
                            Data Calon
                        </a>

                        <a href="/reports/scores" class="block px-4 py-2 hover:bg-gray-100">
                            Penilaian
                        </a>

                        <a href="/reports/rankings" class="block px-4 py-2 hover:bg-gray-100">
                            Hasil Ranking
                        </a>
